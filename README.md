...
Дашборд прогноза северного сияния для Мурманска (68.97° с. ш., 33.07° в. д.): текущий Kp-индекс, облачность по ярусам и итоговая оценка шанса увидеть сияние.
...
| Блок | Содержимое |
|---|---|
| Шанс увидеть сияние | Низкий / средний / высокий, пояснение и список учтённых факторов |
...
```
index.html   разметка: вердикт, Kp, облачность, прогноз
...
Вердикт относится к текущему моменту, а не к ночи целиком: подсказка лучшего окна наблюдения — следующий пункт в планах.
