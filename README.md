...
Две вкладки: **«Сейчас»** — условия в выбранной точке, **«Куда ехать ночью»** — сравнение всех семи точек на ближайшую ночь. Вкладка запоминается и отражается в адресе (`#now`, `#tonight`), так что ссылкой можно поделиться. На широком экране навигация сверху, на узком — внизу экрана.
