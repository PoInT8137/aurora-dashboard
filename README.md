...
Дашборд прогноза северного сияния для Мурманска (68.97° с. ш., 33.07° в. д.): текущий Kp-индекс, облачность по ярусам, оценка шанса увидеть сияние и лучшее время для наблюдения ближайшей ночью.

**[Открыть живую версию →](https://point8137.github.io/aurora-dashboard/)**

![Дашборд прогноза северного сияния: вердикт, окно наблюдения, Kp-индекс, облачность по ярусам и прогноз на трое суток](screenshot.png)
...
**Kp.** Пороги занижены относительно привычных: Мурманск лежит практически под авроральным овалом (геомагнитная широта ≈ 64°), и сияние здесь возможно уже при Kp 2, тогда как в средней полосе нужен Kp 5–6.
...
**Высота Солнца** считается локально, без запросов к API. С мая по июль в Мурманске полярный день, и при любом Kp и чистом небе сияние не видно, поэтому светлое небо принудительно опускает вердикт до низкого.
...
Дашборду нужны только первые три файла. Папка `tools/` — одноразовые проверки на Node.js, к странице отношения не имеют; подробности в [tools/README.md](tools/README.md).
